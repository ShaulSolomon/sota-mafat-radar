...
from src.models import arch_setup, dataset_ram_reduced, base_3d
...
#%%
log_filename = "alexnet_3d.log"
if os.path.exists(log_filename):
    os.remove(log_filename)

logging.basicConfig(level=logging.INFO,
                    filename='alexnet_3d.log',
...
val_loader=DataLoader(dataset= val_set, batch_size = batch_size, shuffle = True, num_workers = 8)

#%%

model= base3d.alex_mdf_model()
